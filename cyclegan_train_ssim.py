...
def train(filename_A='/media/root/4c3b1a1e-e2bc-42fe-aeff-321d032e5c70/tensorflow/Multi_center/cyc data/chase/tf record/chase.tfrecords',
    ...
    with tf.variable_scope("loss") as scope:
        ...
        g_loss_A = cyc_loss * 10 + disc_loss_B + patch_disc_loss_B
        g_loss_B = cyc_loss * 10 + disc_loss_A + patch_disc_loss_A
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(sess.run(global_step),epochs):
            ...
            for ptr in range(0, max_images):
                ...
                print('%d g_loss_A is %s,g_loss_A is %s,d_loss_A is %s,d_loss_b is %s,patch_d_loss_a is %s,patch_d_loss_b is %s'%(ptr,G_loss_A,G_loss_B,D_loss_A,D_loss_B,patch_D_loss_A,patch_D_loss_B))
